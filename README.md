...
├── scripts/
│   ├── validate_scores.py       # Canonical cleaning rules + sanity checks (per judge)
│   └── build_leaderboard.py     # Long CSVs -> docs/data/*.json (acceptance-gated)
├── results/
│   ├── scores/                  # Per-expression long CSVs (opus46_*, gpt55_*)
